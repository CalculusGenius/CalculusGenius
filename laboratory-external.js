(() => {
  const experiments = [
    ...
    ["FRACTAL","Infinite detail","Explore a complex-looking iterative construction in GeoGebra, then zoom and ask whether the same geometry repeats.","z=x^2+y^2"],
    ...
    ["PROBABILITY","Geometry meets randomness","Use GeoGebra's probability and random tools to explore distributions, expectation and sampling.",""],
    ...
    ["TOPOLOGY","Stretch without tearing","Construct shapes and continuously deform them. Ask which properties remain unchanged under deformation.",""],
    ["LINEAR ALGEBRA","Transform the plane","Use vectors and transformations to see how matrices act geometrically. Change entries one at a time.",""],
